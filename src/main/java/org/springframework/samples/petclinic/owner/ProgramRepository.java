...
public interface ProgramRepository extends Repository<Program, Integer> {
    ...
    Collection<Program> findByLastName(@Param("programName") String programName);
    ...
    @Transactional(readOnly = true)
    Program findById(@Param("id") Integer id);
    
    @Query("delete FROM Program program WHERE program.id =:id")
    @Modifying
    @Transactional
